...
public:
	...
	UFUNCTION(BlueprintCallable, Category="Snap to Ground")
	void SnapZoneShapesToGround(TArray<UZoneShapeComponent*> Components);
...
private:
	...
	bool SnapPointToGround(UWorld* World, USceneComponent* ZoneComponent, FVector& Point, FVector& UpVector, FVector& TangentVector);
