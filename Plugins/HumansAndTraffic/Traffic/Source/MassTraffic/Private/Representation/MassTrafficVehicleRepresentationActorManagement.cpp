...
#include "Representation/MassTrafficVehicleRepresentationActorManagement.h"
#include "Processor/MassTrafficVehicleVisualizationProcessor.h"
#include "Components/MassTrafficVehicleComponent.h"
#include "Interfaces/MassTrafficVehicleControlInterface.h"
...
void UMassTrafficVehicleRepresentationActorManagement::InitLowResActor(AActor& LowResActor, const FMassEntityView& EntityView) const
{
	...
	const FMassTrafficPackedVehicleInstanceCustomData PackedCustomData = FMassTrafficVehicleInstanceCustomData::MakeTrafficVehicleCustomData(VehicleStateFragment, RandomFractionFragment, false, FLinearColor::Transparent, FVector::ZeroVector, true);
...
void UMassTrafficVehicleRepresentationActorManagement::InitHighResActor(AActor& HighResActor, const FMassEntityView& EntityView) const
{
	...
	const FMassTrafficPackedVehicleInstanceCustomData PackedCustomData =
		FMassTrafficVehicleInstanceCustomData::MakeTrafficVehicleCustomData(VehicleStateFragment, RandomFractionFragment,
																	false, FLinearColor::Transparent, FVector::ZeroVector, true);
