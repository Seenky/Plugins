...
int32 GDebugMassTrafficTransformFix = 0;
FAutoConsoleVariableRef CVarDebugMassTrafficTransformFix(
	TEXT("MassTraffic.DebugTransformFix"),
	GDebugMassTrafficTransformFix,
	TEXT("MassTraffic debug mode transform.\n")
	TEXT("0 = Off (default.)\n")
	TEXT("1 = Debug draw line traces for fix transform"),
	ECVF_Cheat
	);

int32 GDebugMassTrafficGates = 0;
FAutoConsoleVariableRef CVarDebugMassTrafficGates(
	TEXT("MassTraffic.DebugTrafficGates"),
	GDebugMassTrafficGates,
	TEXT("MassTraffic debug mode gates.\n")
	TEXT("0 = Off (default.)\n")
	TEXT("1 = Debug draw lines for gates"),
	ECVF_Cheat
	);

int32 GDebugMassTrafficBumps= 0;
FAutoConsoleVariableRef CVarDebugMassTrafficBumps(
	TEXT("MassTraffic.DebugTrafficBumps"),
	GDebugMassTrafficBumps,
	TEXT("MassTraffic debug mode bumps.\n")
	TEXT("0 = Off (default.)\n")
	TEXT("1 = Debug draw lines for bumps"),
	ECVF_Cheat
	);
...
int32 GMassTrafficDebugEmergencyStop = 0;
FAutoConsoleVariableRef CVarMassTrafficDebugEmergencyStop(
	TEXT("MassTraffic.DebugEmergencyStop"),
	GMassTrafficDebugEmergencyStop,
	TEXT("MassTraffic distance to emergency stop.\n")
	TEXT("0 = Off (default.)\n")
	TEXT("1 = On\n"),
	ECVF_Cheat
	);
