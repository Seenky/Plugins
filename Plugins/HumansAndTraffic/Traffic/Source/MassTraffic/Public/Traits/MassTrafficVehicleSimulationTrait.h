...
UENUM(BlueprintType)
enum class EMassTrafficVehicleType : uint8
{
	Vehicle,
	Bicycle,
};
...
public:
	 ...
	 */  
	UPROPERTY(EditAnywhere, Category = "Dimensions", BlueprintReadWrite)
	...
	*/  
	...
	UPROPERTY(EditAnywhere, Category = "Dimensions", BlueprintReadWrite)
	float WheelsRadius = 25.0f;

	UPROPERTY(EditAnywhere, Category = "Dimensions", BlueprintReadWrite)
	float WheelsOffset = 0.0f;

	UPROPERTY(EditAnywhere, Category = "Dimensions", BlueprintReadWrite)
	EMassTrafficVehicleType VehicleType = EMassTrafficVehicleType::Vehicle;
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Mass Traffic", BlueprintReadWrite)
