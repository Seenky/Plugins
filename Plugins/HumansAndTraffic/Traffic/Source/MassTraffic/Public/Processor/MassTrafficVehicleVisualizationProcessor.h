...
struct MASSTRAFFIC_API FMassTrafficVehicleInstanceCustomData
{
	...
	static FMassTrafficVehicleInstanceCustomData MakeTrafficVehicleCustomData(
		...
		bool bIsInvisible, const FLinearColor Color, const FVector& RightVector, const bool bIsDay);
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere)
	bool bIsInvisible = false; // PackedParam1[16 + 11] - Max is 15 !

	UPROPERTY(BlueprintReadWrite, EditAnywhere)
	bool bIsCarActive = false; // PackedParam1[16 + 12] - Max is 15 !

	UPROPERTY(BlueprintReadWrite, EditAnywhere)
	bool bUseDither = false; // PackedParam1[16 + 13] - Max is 15 !

	UPROPERTY(BlueprintReadWrite, EditAnywhere)
	bool bIsDay = true; // PackedParam1[16 + 14] - Max is 15 !
...
struct MASSTRAFFIC_API FMassTrafficPackedVehicleInstanceCustomData
{
	...
	explicit FMassTrafficPackedVehicleInstanceCustomData(
		const float InPackedParam1, const float InPackedParam2, const float InPackedParam3,
		const float InPackedParam4, const float InPackedParam5)
		: PackedParam1(InPackedParam1)
		, PackedParamColorRG(InPackedParam2)
		, PackedParamColorB(InPackedParam3)
		, PackedParamRightVectorXY(InPackedParam4)
		, PackedParamRightVectorZ(InPackedParam5)
	{}
	...
	UPROPERTY(BlueprintReadWrite, VisibleAnywhere)
	float PackedParamColorRG = 0.0f;
	UPROPERTY(BlueprintReadWrite, VisibleAnywhere)
	float PackedParamColorB = 0.0f;
	UPROPERTY(BlueprintReadWrite, VisibleAnywhere)
	float PackedParamRightVectorXY = 0.0f;
	UPROPERTY(BlueprintReadWrite, VisibleAnywhere)
	float PackedParamRightVectorZ = 0.0f;
};
