...
void UOptimizationProxyComponent::SetupSwapMeshes(USkeletalMeshComponent* SkeletalMeshComponent)
{
	SkeletalMeshComp = SkeletalMeshComponent;
}
		...
		case EOptimizationWave::FirstWave:
			{
				...
				if (bUseSwap && SkeletalMeshComp.IsValid())
				{
					SkeletalMeshComp->SetVisibility(!FirstWave_bSwapMeshes);
					SkeletalMeshComp->SetRenderStatic(FirstWave_bSwapMeshes);
					SkeletalMeshComp->bPauseAnims = FirstWave_bSwapMeshes;
				}
			}
			break;
		case EOptimizationWave::SecondWave:
			{
				...
				if (bUseSwap && SkeletalMeshComp.IsValid())
				{
					SkeletalMeshComp->SetVisibility(!SecondWave_bSwapMeshes);
					SkeletalMeshComp->SetRenderStatic(SecondWave_bSwapMeshes);
					SkeletalMeshComp->bPauseAnims = SecondWave_bSwapMeshes;
				}
			}
			break;
		case EOptimizationWave::ThirdWave:
			{
				...
				if (bUseSwap && SkeletalMeshComp.IsValid())
				{
					SkeletalMeshComp->SetVisibility(!ThirdWave_bSwapMeshes);
					SkeletalMeshComp->SetRenderStatic(ThirdWave_bSwapMeshes);
					SkeletalMeshComp->bPauseAnims = ThirdWave_bSwapMeshes;
				}
			}
			break;
		case EOptimizationWave::Invisible:
			{
				...
				if (bUseSwap && SkeletalMeshComp.IsValid())
				{
					...
					SkeletalMeshComp->SetRenderStatic(true);
