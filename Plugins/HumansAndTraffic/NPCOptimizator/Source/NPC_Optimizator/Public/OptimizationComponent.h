...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "NPC Optimizator")
	void					 SetupSwapMeshes(USkeletalMeshComponent* SkeletalMeshComponent);
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Swap Settings")
	bool bUseSwap = false;
public:
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Optimization|First wave|Skeletal meshes", DisplayName = "Swap meshes")
	bool FirstWave_bSwapMeshes = false;
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Optimization|Second wave|Skeletal meshes", DisplayName = "Swap meshes")
	bool SecondWave_bSwapMeshes = true;
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Optimization|Third wave|Skeletal meshes", DisplayName = "Swap meshes")
	bool ThirdWave_bSwapMeshes = true;
