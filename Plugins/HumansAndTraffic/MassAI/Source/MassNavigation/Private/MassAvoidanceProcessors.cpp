...
void UMassMovingAvoidanceProcessor::Execute(FMassEntityManager& EntityManager, FMassExecutionContext& Context)
{
	...
	EntityQuery.ForEachEntityChunk(EntityManager, Context, [this, &EntityManager](FMassExecutionContext& Context)
	{
		...
		const TArrayView<FMassShouldUseAvoidanceFragment> ShouldUseAvoidanceFragments = Context.GetMutableFragmentView<FMassShouldUseAvoidanceFragment>();
		...
		{
			const FMassShouldUseAvoidanceFragment& ShouldUseAvoidanceFragment = ShouldUseAvoidanceFragments[EntityIndex];
			if (!ShouldUseAvoidanceFragment.bShouldUseAvoidance) continue;
...
void UMassStandingAvoidanceProcessor::ConfigureQueries()
{
	...
	EntityQuery.AddRequirement<FTransformFragment>(EMassFragmentAccess::ReadOnly);
	EntityQuery.AddRequirement<FAgentRadiusFragment>(EMassFragmentAccess::ReadOnly);
	EntityQuery.AddRequirement<FMassShouldUseAvoidanceFragment>(EMassFragmentAccess::ReadOnly);
	EntityQuery.AddTagRequirement<FMassMediumLODTag>(EMassFragmentPresence::None);
	EntityQuery.AddTagRequirement<FMassLowLODTag>(EMassFragmentPresence::None);
	EntityQuery.AddTagRequirement<FMassOffLODTag>(EMassFragmentPresence::None);
...
void UMassStandingAvoidanceProcessor::Execute(FMassEntityManager& EntityManager, FMassExecutionContext& Context)
{
	...
	EntityQuery.ForEachEntityChunk(EntityManager, Context, [this, &EntityManager](FMassExecutionContext& Context)
	{
		...
		const TConstArrayView<FMassShouldUseAvoidanceFragment> ShouldUseAvoidanceFragments = Context.GetFragmentView<FMassShouldUseAvoidanceFragment>();
