...
USTRUCT()
struct MASSNAVIGATION_API FMassShouldUseAvoidanceFragment : public FMassFragment
{
	GENERATED_BODY()
	bool bShouldUseAvoidance = true;
};

UENUM()
enum class ECurrentRepresentationType : uint8
{
	None,
	Actor,
	Niagara,
...
USTRUCT()
struct MASSNAVIGATION_API FCurrentRepresentationFragment : public FMassFragment
{
	GENERATED_BODY()
	ECurrentRepresentationType CurrentRepresentationType = ECurrentRepresentationType::Actor;
};

USTRUCT()
struct MASSNAVIGATION_API FMassVisibilityFragment : public FMassFragment
{
	GENERATED_BODY()
	bool bIsInFov = true;
